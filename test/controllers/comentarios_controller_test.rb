...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { autor: @comentario.autor, curso_id: @comentario.curso_id, texto: @comentario.texto } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { autor: @comentario.autor, curso_id: @comentario.curso_id, texto: @comentario.texto } }
