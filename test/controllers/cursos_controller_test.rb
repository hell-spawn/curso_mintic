...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { descripcion: @curso.descripcion, titulo: @curso.titulo } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { descripcion: @curso.descripcion, titulo: @curso.titulo } }
